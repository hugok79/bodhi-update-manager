"""Entry point for the Update Manager."""
...
def _sanitize_gtk_modules() -> None:
    ...
    Some setups export GTK3_MODULES=xapp-gtk3-module even when the module is
    not installed, causing GTK warnings on startup.
    """
